...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Dashboard/</span>Pembeli</h4>
    <!-- Bordered Table -->
    <div class="card">
          ...
          <div class="table-responsive text-nowrap">
            ...
            <table class="table table-bordered">
              ...
              <tbody>
                  ...
                  <td>
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu">
                        <a class="dropdown-item" type="button" data-bs-toggle="modal" data-bs-target="#editModalKat{{$items->id}}"><i
                            class="bx bx-edit-alt me-1"></i> Edit</a>
                        <a class="dropdown-item"  type="button" data-bs-toggle="modal" data-bs-target="#hapusModalKat{{$items->id}}"
                ...
                @include('contents.dashboard.users.edit')
                @include('contents.dashboard.users.hapus')
                @endforeach
              </tbody>
            </table>
