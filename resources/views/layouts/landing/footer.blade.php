               ...
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 mb-50 wow rrfadeUp" data-wow-duration=".9s"
                  ...
                  <div class="rr-footer-widget footer-cols-1">
                     <div class="rr-footer-logo pb-20">
                        <a href="index.html"><img src="{{asset('logo-2.png')}}" alt="img"></a>
                     </div>
                     <div class="rr-footer-widget-content mb-25">
                        <p>Kami akan membantu mewujudkan pernikahan impian Anda.
                           mengatur semuanya mulai dari pertemuan keluarga hingga
                           pengelolaan janji dengan pemasok pernikahan. Kami melakukan
                           segalanya untuk Anda.</p>
                     </div>
                  ...
                  <div class="rr-footer-widget footer-cols-1">
                     ...
                     <div class="rr-footer-widget-content mb-25">
                        ...
                        <div class="rr-footer-widget-content-item">
                           ...
                           <a href="mailto:Paras Ayu Sona Wedding@gmail.com">ParasAyuSonaWedding@gmail.com</a>
                        </div>
                        <div class="rr-footer-widget-content-item">
                           ...
                           <a href="tel:888123869523">085224248355</a>
                        </div>
                        <div class="rr-footer-widget-content-item">
                           ...
                           <a href="#"> Jl. Taman Kaliwulu indah, Kaliwulu, Kec. Plered, Kabupaten Cirebon, Jawa Barat</a>
                        </div>
            ...
            <div class="row align-items-center">
               <div class="col-xl-12 wow rrfadeUp" data-wow-duration=".9s" data-wow-delay=".3s">
                  <div class="rr-copyright-left text-center">
                     <p>© 2024 <a href="#"> Paras Ayu Sona Wedding.</a> Design By RRDevs. All Rights Reserved.</p>
                  </div>
               </div>
            </div>
         </div>
